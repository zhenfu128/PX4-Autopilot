...
class MavrosTestCommon():
    def __init__(self, *args):
        ...
        self.set_arming_srv = rospy.ServiceProxy('uav2/mavros/cmd/arming', CommandBool)
        self.set_mode_srv = rospy.ServiceProxy('uav2/mavros/set_mode', SetMode)
        self.wp_clear_srv = rospy.ServiceProxy('uav2/mavros/mission/clear', WaypointClear)
        self.wp_push_srv = rospy.ServiceProxy('uav2/mavros/mission/push', WaypointPush)

        # ROS subscribers
        self.alt_sub = rospy.Subscriber('uav2/mavros/altitude', Altitude, self.altitude_callback)
        self.ext_state_sub = rospy.Subscriber('uav2/mavros/extended_state', ExtendedState, self.extended_state_callback)
        self.global_pos_sub = rospy.Subscriber('uav2/mavros/global_position/global', NavSatFix, self.global_position_callback)
        self.imu_data_sub = rospy.Subscriber('uav2/mavros/imu/data', Imu, self.imu_data_callback)
        self.home_pos_sub = rospy.Subscriber('uav2/mavros/home_position/home', HomePosition, self.home_position_callback)
        self.local_pos_sub = rospy.Subscriber('uav2/mavros/local_position/pose', PoseStamped, self.local_position_callback)
        self.mission_wp_sub = rospy.Subscriber('uav2/mavros/mission/waypoints', WaypointList, self.mission_wp_callback)
        self.state_sub = rospy.Subscriber('uav2/mavros/state', State, self.state_callback)
